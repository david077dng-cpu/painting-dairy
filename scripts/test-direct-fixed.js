// Test direct API call with correct auth
const API_BASE_URL = 'https://ark.cn-beijing.volces.com/api/anthropic';
const API_AUTH_TOKEN = '7a329475-3d02-410c-9128-4ca39f861491';
const API_MODEL = 'kimi-k2.5';
const ANTHROPIC_VERSION = '2023-06-01';

async function testPromptGeneration() {
  console.log('Testing prompt generation (Anthropic format with Bearer auth)...');
  console.log('Config:');
